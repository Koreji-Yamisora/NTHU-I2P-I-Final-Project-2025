...
class MenuScene(Scene):
    ...
    def __init__(self):
        ...
        px, py = (GameSettings.SCREEN_WIDTH // 2, GameSettings.
            SCREEN_HEIGHT * 3 // 4)
        ...
        self.play_button = Button('UI/button_play.png',
            'UI/button_play_hover.png', px + 50, py, 100, 100, lambda :
            scene_manager.change_scene('game'))
        self.settings_button = Button('UI/button_setting.png',
            'UI/button_setting_hover.png', px - 150, py, 100, 100, lambda :
